...
SET OVMF="%CD%\bios\OVMF-pure-efi.fd"

ECHO.
ECHO NASM UEFI Build Script
ECHO.

@rem IF "%VSCMD_ARG_HOST_ARCH%" NEQ "x64" GOTO :ErrorX64
@rem IF "%VSCMD_ARG_TGT_ARCH%" NEQ "x64" GOTO :ErrorX64
...
qemu-system-x86_64 -bios %OVMF% -drive file=%VHD%,format=raw
